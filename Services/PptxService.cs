...
namespace pptx_creator.Services
{
    public class PptxService
    {
        ...
        {
            string filepath = @"my_pptx_1.pptx";
        ...
        {
            SlideMasterPart slideMasterPart1 = slideLayoutPart1.AddNewPart<SlideMasterPart>("rId1"); // Add to slide master list part.
        ...
        {
            using (PresentationDocument presentationDocument = PresentationDocument.Open(@"my_pptx_1.pptx", true))
            {
                int position = 1;
